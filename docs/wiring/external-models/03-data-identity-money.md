...
|---|---|---|---|
| `ext-crm-oauth-grant` | `by-design` | `oauth_granted` | — |
| `ext-payment-kyb-funding` | `by-provisioning` | `payment_identity_provisioned` | — |
| `ext-counsel-mt-msb` | `by-design` | `counsel_mt_msb_cleared` | — |
| `ext-ad-platform-export` | `by-design` | `ad_export_authorized` | — |
