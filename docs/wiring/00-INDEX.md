...
**Layer:** CTO / technical column — backend with no face.  
**Stance:** Connect first, classify later. Design-invariant (event/state language, not UI arrangement).
...
| [`external-models/00-INDEX.md`](./external-models/00-INDEX.md) | **Pass A** — Think Stack → external systems + modelability (67) |
