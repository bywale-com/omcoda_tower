...
export const seat: SmeSeat = {
  ...
  items: [
    ...
    },
    {
      ...
      implementation: "On **Ticket** / **Support context**, you can now see reason code, priority, verbatim reply, confidence, sequence id, owner, pending attempt, and consent/silence snapshot.  \nOn **Escalation queue**, list rows show reason + priority for triage sort.  \nOn **Audit trail**, you can now open the escalation-opened Change event with the same bundle.",
