  ...
  items: [
    {
      ...
      implementation: "On Authorize book, you can now pick Connection stack for the firm’s actual system of record (file export, assisted confirm, or live CRM when available) — same hard-input outcome, not separate finish lines.  \nOn Activation state, you can now read book-auth landed only after that stack completes — never stack-specific partials.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, you can now choose file-export as a first-class Connection stack (not a fallback label).  \nOn Imports, you can now land the firm-authorized contact list into Contacts as the mutable book for that tenancy.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, you can now set Cohort purpose before release (dormant / past leads / closed files vs open matters).  \nOn Contacts, you can now read the authorized cohort boundary on the landed book — not an unlabeled full dump.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, you can now complete one Book authorized outcome regardless of Connection stack — with provenance and channel fields required on land.  \nOn Activation state, you can now flip book-auth only on that shared outcome (not on token alone, file-received alone, or staff seed alone).",
    ...
    },
    {
      ...
      implementation: "Starting from Prepared Workspace, you can now open Authorize book only after readiness — never from Approach capture.  \nOn Authorize book, you can now hand over the private book that Contacts will mutate; Acquisition surfaces never create that book.",
    ...
    },
    {
      ...
      implementation: "On Contacts, when Imports already holds an assisted list, you can now Confirm imported book as the authorization act.  \nOn Activation state, you can now mark book-auth landed only after that confirm — not when staff seeded Imports.",
    ...
    },
    {
      ...
      implementation: "On Prepared Workspace, you can now read readiness theater as staged campaign under firm identity — not as Contacts populated.  \nOn Contacts, you can now stay empty of private book until Authorize book (or Confirm imported book) lands — scrape never fills the directory.",
    ...
    },
    {
      ...
      implementation: "On Authorize book / Imports, you can now accept a row only when identity, display name, and ≥1 channel candidate (email and/or phone as present in source) land.  \nOn Book readiness, you can now refuse Audit-eligible enrollment for empty-channel-only rows marked not-landed.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, when Connection stack is live-crm, you can now acknowledge Scope summary (contacts/leads + reachability fields only) before grant.  \nOn Contacts, you can now land only those scoped objects — matters/billing/documents stay out of the book.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, you can now choose Connection stack by what the firm can authorize today (file-export if that is the SoR; live-crm if admin-capable) — neither labeled temporary vs real.  \nOn Imports / Contacts, you can now land either stack into the same mutable book schema after Prepared Workspace readiness.",
    ...
    },
    {
      ...
      implementation: "On Authorize book, you can now read Sync posture as one-way-land (CRM/file → Tower) with bidirectional deferred — not offered as a V1 control.  \nOn Activation state, you can now reach running on book-auth ∩ escrow without any sync-complete flag.",
    ...
    },
    {
      ...
      implementation: "On Authorize book / Contacts, you can now read Sync posture: write-back not in V1; identity and channels stay firm-SoR owned.  \nOn Board, you can now treat engagement chronology as desk inhabit — not CRM field admin or silent master of the practice record.",
    ...
    },
    {
      ...
      implementation: "On Activation state / Authorize book, you can now mark connect-complete only when mutable cohort + provenance + match keys + channel candidates + cohort boundary all hold.  \nOn Book readiness, you can now start Audit run only from connect-complete — not from file-received or readiness theater.",
    ...
    },
    {
      ...
      implementation: "On Book readiness / Verdict list, you can now map validator classes to reachable / partial / unreachable after Audit run.  \nOn Authorize book, you can now land channel candidates only — validators consume them on Book readiness, not at connect.",
    ...
    },
    {
      ...
      implementation: "On Imports, you can now preserve source suppression fields (do-not-contact / silenced / marketing-status) as opaque flags on Contacts.  \nOn Book readiness, you can now hand those flags to Audit as data-validity inputs — Authorize book never interprets CASL lawfulness.",
    ...
    },
    {
      ...
      implementation: "On Authorize book (from Prepared Workspace or Contacts after running), you can now Re-hand over book — re-export or re-pull upserts by match key.  \nOn Activation state, you can now keep ALG/escrow intact across refresh; Book readiness you can now re-batch Audit after upsert.",
