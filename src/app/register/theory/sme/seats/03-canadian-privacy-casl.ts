  ...
  items: [
    {
      ...
      implementation: "On Firm operations bind firm detail → Send gates panel, you can now see CEM triad required readiness row (consent + identification + unsubscribe) before Armed / Active may ship any firm-branded email or SMS.\nOn Opt-in message and Nudge message, you can now see firm identification and a working unsubscribe path on every CEM — phase never drops the triad.",
    ...
    },
    {
      ...
      implementation: "On Firm operations bind firm detail → Send gates panel, you can now see Consent basis required with allowed values express already on file or typed implied before Opt-in message may fire.\nOn Book readiness Verdict list, contacts without a documented Consent basis show not ready for opt-in CEM — cold book-wide consent asks stay blocked.",
    ...
    },
    {
      ...
      implementation: "On Firm operations bind firm detail → Send gates panel, you can now see policy summary rows for CEM consent/unsubscribe procedures and firm-vs-platform role split before arming.\nOn Audit trail, you can now see Consent events and bind/arm actions that demonstrate accountability for firm-branded CEMs Om Coda enables.",
    ...
    },
    {
      ...
      implementation: "On Firm operations bind firm detail → Send gates panel, you can now see firm-accountable readiness row for client PI and CEM consent claims; Om Coda refuses sends lacking ledgered consent.\nOn Audit trail Consent events, firm custody + platform fail-closed enforcement both appear so coexistence is visible to operators.",
