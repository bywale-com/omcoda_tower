...
export const seat: SmeSeat = {
  ...
  items: [
    ...
    },
    {
      ...
      implementation: "Starting from Firm operations bind, click a Firm row to open firm detail, then open the Send gates panel. View the Consent basis required readiness row with allowed chips for Express already on file or Typed implied before the Opt-in message send button may fire.\nStarting from Book readiness, click Audits, open an Audit run, then view the Verdict list. Contacts without a documented Consent basis show a not-ready-for-opt-in-CEM verdict row, so cold book-wide consent asks stay blocked.",
    ...
    },
    {
      ...
      implementation: "On Silence / Opt out state, inbound STOP / Unsubscribe and equivalent keywords set an authoritative silence chip for that SMS address, the same as the in-message Silence / Opt out button.  \nOn Audit trail, click a Consent event row to open SMS stop-keyword silence alongside touchpoint Silence / Opt out.",
    ...
    },
    {
      ...
      implementation: "Starting from Agent / sequence editor, open the Approach first-text adjacent template row. Require First-text copy fields to identify Om Coda, include prescribed contact info plus unsubscribe, and speak only to the captured consultant's professional interest in Prepared Workspace.  \nOn Capture strip, click First-text; the send button stays disabled when required form fields are incomplete or off-role copy is flagged.",
