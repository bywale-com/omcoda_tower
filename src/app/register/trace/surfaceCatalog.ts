...
export const SURFACE_CATALOG: RegisterSurfaceEntry[] = [
  ...
  entry("Engagement record", "consultant", "Board", "exists"),
  entry("Client Brief", "consultant", "Board", "exists"),
  ...
  entry("Phase signal legend", "consultant", "Board", "new"),
  entry("Board search", "consultant", "Board", "new"),
  entry("Today's meetings", "consultant", "Board", "new"),
  entry("Copy brief", "consultant", "Meetings", "new"),
  entry("Starts in", "consultant", "Meetings", "new"),
  entry("Newest first", "consultant", "Board", "new"),
  entry("Export chronology", "consultant", "Board", "new"),
  entry("Download terms", "consultant", "Prepared Workspace", "new"),
  entry("Resend code", "consultant", "Login", "new"),
  entry("List / Calendar", "consultant", "Meetings", "new"),
  entry("Lift halt", "consultant", "Board", "new"),
  entry("Accepted terms", "consultant", "Board", "new"),
  ...
  entry("Campaign review state", "operator", "Acquisition & ads", "new"),
  entry("Campaign delivery state", "operator", "Acquisition & ads", "new"),
  ...
  entry("Sending infrastructure", "operator", "Sending infrastructure", "new"),
  entry("Sending-domain pool", "operator", "Sending infrastructure", "new"),
  entry("Allocate subdomain", "operator", "Sending infrastructure", "new"),
  entry("Authentication panel", "operator", "Sending infrastructure", "new"),
  entry("Warmup", "operator", "Sending infrastructure", "new"),
  entry("Envelope panel", "operator", "Sending infrastructure", "new"),
  entry("Reputation units", "operator", "Sending infrastructure", "new"),
  ...
  entry("Published-only helper", "operator", "Firm operations bind", "new"),
  entry("Jump to Configuration libraries", "operator", "Firm operations bind", "new"),
  entry("Bind-completeness", "operator", "Firm operations bind", "new"),
  entry("Armed / Active", "operator", "Firm operations bind", "new"),
  entry("Send gates", "operator", "Firm operations bind", "new"),
  entry("ESP policy reject", "operator", "Firm operations bind", "new"),
  entry("Domain authentication readiness", "operator", "Firm operations bind", "new"),
  ...
  entry("Verdict legend", "operator", "Book readiness", "new"),
  entry("Sequence-ready glance", "operator", "Book readiness", "new"),
  entry("Verdict filter", "operator", "Book readiness", "new"),
  entry("Re-audit remainder", "operator", "Book readiness", "new"),
  ...
  entry("Progress Jump", "operator", "Activation state", "new"),
];
